...
<html>
    ...
    <div class="index-content">
        <div class="index-content-operation">
            <a class="info-detail">修改学生 </a>
            <br>
            <br>
        </div>
        <br>
        <form action="StudentServlet?action=edit" method="post" onsubmit="return check()">
