    ...
    <div class="index-content">
        ...
        <form action="NoticeServlet?action=edit" method="post" onsubmit="return check()">
            ...
            <table class="index-content-table-add">
                <tr>
                    <td width="12%">标题:</td>
                    <td><input class="index-content-table-td-add" type="text" id="noticeName" name="noticeName"
                               value="${vo.noticeName}"/></td>
                </tr>
                <tr>
                    <td width="12%">内容:</td>
                    <td><textarea id="noticeText" name="noticeText" style="width: 60%; height: 100px;padding: 0px 17px;"
                                  placeholder="请输入内容......">${vo.noticeText}</textarea></td>
                </tr>
                <tr>
                    <td width="12%">类型:</td>
                    <td><input class="index-content-table-td-add" type="text" id="noticeType" name="noticeType"
                               value="${vo.noticeType}"/></td>
                </tr>
                <tr>
                    <td width="12%">创建时间:</td>
                    <td><input class="index-content-table-td-add" type="text" id="createDate" name="createDate"
