    ...
    <div class="index-nav" style="opacity: 0.8">
        <div class="index-nav-frame clearfix">
            ...
            <div class="index-nav-frame-line" tabindex="-1">
                <a class="btn btn-line btn-success btn-sm" href="UserServlet?action=get&id=${loginUser.id}">个人信息</a>
            </div>
            <div class="index-nav-frame-line" tabindex="-1">
                <a class="btn btn-line btn-success btn-sm" href="AdministratorServlet">宿管员信息</a>
            </div>
            <div class="index-nav-frame-line" tabindex="-1">
                <a class="btn btn-line btn-success btn-sm" href="NoticeServlet">公告列表</a>
            </div>
            <div class="index-nav-frame-line" tabindex="-1">
