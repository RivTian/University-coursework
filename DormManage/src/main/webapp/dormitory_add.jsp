...
<html>
    ...
    <div class="index-content">
        <div class="index-content-operation">
            <a class="info-detail">添加宿舍 </a>
            <br>
            <br>
        </div>
        <br>
        <form action="DormitoryServlet?action=add" method="post" onsubmit="return check()">
