...
<html>
    ...
    <div class="index-content">
        <div class="index-content-operation">
            <a class="info-detail">修改宿管员 </a>
            <br>
            <br>
        </div>
        <br>
        <form action="AdministratorServlet?action=edit" method="post" onsubmit="return check()">
            ...
            <table class="index-content-table-add">
                <tr>
                    ...
                    <td><input class="index-content-table-td-add" type="text" id="administratorName"
                               name="administratorName" value="${vo.administratorName}"/></td>
                </tr>
                <tr>
                    <td width="12%">性别:</td>
                    <td>
                        <input name="administratorSex" type="radio" value="男" ${vo.administratorSex=='男'?'checked':''}/>&nbsp;&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="administratorSex" type="radio" value="女" ${vo.administratorSex=='女'?'checked':''}/>&nbsp;&nbsp;&nbsp;女&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td width="12%">电话:</td>
                    <td><input class="index-content-table-td-add" type="text" id="administratorPhone"
                               name="administratorPhone" value="${vo.administratorPhone}"/></td>
                </tr>
                <tr>
                    <td width="12%">楼栋:</td>
                    <td><input class="index-content-table-td-add" type="text" id="administratorBuilding"
                               name="administratorBuilding" value="${vo.administratorBuilding}"/></td>
                </tr>
                <tr>
                    <td width="12%">备注:</td>
                    <td><textarea id="administratorText" name="administratorText"
                                  style="width: 60%; height: 100px;padding: 0px 17px;"
                                  placeholder="请输入内容......">${vo.administratorText}</textarea></td>
                </tr>
            </table>
            <br>
            <br>
